...
\section{Introduction and Motivation}
    \begin{frame}{Introduction to SMKIT}
        \vspace{0.5cm}
        \begin{itemize}
            \item \textbf{SMKIT: A modular tool for automating social media and web content posting.}
            \item Designed to process web pages, extract metadata, and generate posts for various platforms.
        \end{itemize}

        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{images/introduction_and_motivation_introduction_to_smkit_slide_image_pycharm.png}
        \end{center}
    \end{frame}
