...
\begin{itemize}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=1\textwidth]{figures/methodology/methodology_system_architecture_data_flow_transparent_background.png}
        \caption{Data Flow}
        \label{fig:methodology_system_architecture_data_flow}
...
The diagram above illustrates how these components are structured and interact with one another to create a streamlined system for automating content generation and distribution. \end{comment} 
